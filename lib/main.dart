...
import 'misc/controllers/locale_controller.dart';
import 'misc/controllers/shared_preference_controller.dart';
...
App({ Key? key }) : super(key: key);
  ...
  Future<void> _setupLocaleController() async {
    final preferredLocale =
        await sharedPreferencesController.getLocalePreference();
    localeController.switchLocale(preferredLocale);
  }
}
